  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="border-border bg-card sm:max-w-[400px]">
        <DialogHeader>
          <DialogTitle className="text-lg font-medium text-foreground">Edit contact</DialogTitle>
        </DialogHeader>
        <div className="grid gap-4 py-3">
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="editFirstName" className="text-xs text-muted-foreground">First name</Label>
              <Input id="editFirstName" value={firstName} onChange={(e) => setFirstName(e.target.value)} />
            </div>
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="editLastName" className="text-xs text-muted-foreground">Last name</Label>
              <Input id="editLastName" value={lastName} onChange={(e) => setLastName(e.target.value)} />
            </div>
          </div>
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="editEmail" className="text-xs text-muted-foreground">Email</Label>
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="editCompany" className="text-xs text-muted-foreground">Company</Label>
            <Input id="editCompany" value={company} onChange={(e) => setCompany(e.target.value)} />
          </div>
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="editRole" className="text-xs text-muted-foreground">Role</Label>
            <Input id="editRole" value={role} onChange={(e) => setRole(e.target.value)} />
          </div>
          <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="editNotes" className="text-xs text-muted-foreground">Notes</Label>
            <Textarea
              id="editNotes"
              value={notes}
